# Chapter 1: Optional Alchemist Features
...
The potions in the following list expand the Alchemist's Potions list in _Brirr's Guide to Potioncraft_. The list is organized by potion size. See [Chapter 3: Alchemist's Potions](ch-3-additional-alchemists-potions.md) for full potion descriptions.

##### Alchemist's Potions

| Size | Name |
|:----:|:----:|
|  1   | [Kohl's Single Barrel Bourbon Potion](ch-3-additional-alchemists-potions.md#kohls-single-barrel-bourbon-potion) |
