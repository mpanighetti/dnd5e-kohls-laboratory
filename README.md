...
This work is compatible with Dungeons & Dragons 5th Edition. It makes the following modifications from _System Reference Document 5.2.1_:

- To ensure compatibility with characters created using either _SRD 5.1_ or _SRD 5.2.1_, base-level class and subclass features in this document do not include a level requirement, unless they have additional feature dependencies. You gain such features as soon as you select the corresponding class or subclass.
...
_[Brirr’s Guide to Potioncraft](https://docs.google.com/document/d/1es-Yrl4qiPno4ygHt9EJ-xRJmLhkAYO5f1C7NlgrzP8/edit?usp=sharing)_ © 2023 balab. Used with permission by the author.
